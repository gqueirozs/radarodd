...
.ft-tagline { font-size: 12.5px; color: #9aabc7; line-height: 1.7; max-width: 320px; }
...
.ft-passo-desc { font-size: 11.5px; color: #9aabc7; line-height: 1.65; }
...
.ft-aviso-texto { font-size: 12px; color: #c6d1e6; line-height: 1.75; }
...
.ft-copy { font-size: 11px; color: #9aabc7; display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
